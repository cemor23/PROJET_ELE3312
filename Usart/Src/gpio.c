...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, R1_Pin|R2_Pin|TFT_DC_Pin|R3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = GPIO_EXTI11_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIO_EXTI11_GPIO_Port, &GPIO_InitStruct);
