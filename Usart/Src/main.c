...
/* USER CODE BEGIN PFP */
void getPlayerPos(struct Player *player) {
...
void USART_IRQHandler(USART_TypeDef * USARTx, uint8_t * buffer, uint8_t * pRx_counter, int BufferSize){
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	HAL_UART_Transmit_DMA(&huart5, &player1.x, 1);
  /* USER CODE END 2 */
